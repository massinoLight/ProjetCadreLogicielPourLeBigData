...
def line():
    ...
    totCAs=nbCasTotal(Pays, datetime.datetime(2020, 1, 1), listeData('JSONData/data.json'))
    totMort=nbMortTotal(Pays, datetime.datetime(2020, 1, 1), listeData('JSONData/data.json'))
